                        ...
                        {!reduced && scrolled && (
                            ...
                            >
                                <svg width="38" height="38" className="absolute -rotate-90" viewBox="0 0 32 32" aria-hidden="true">
                                    <circle cx="16" cy="16" r="14" stroke="rgba(0,242,255,0.15)" strokeWidth="2" fill="none" />
                                    <motion.circle
                                        cx="16"
                                        cy="16"
                                        r="14"
                    ...
                    <section className="min-h-[100dvh] flex flex-col items-center justify-center relative pt-24 pb-16 text-center">
                        ...
                        <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
                            ...
                            <div
                                ...
                                style={{
                                    backgroundImage: 'linear-gradient(rgba(0,242,255,0.08) 1px, transparent 1px), linear-gradient(90deg, rgba(0,242,255,0.08) 1px, transparent 1px)',
                        ...
                        <div className="flex flex-col items-center gap-8">
                            ...
                            <div className="flex flex-col items-center gap-1">
                                <span
                                    ...
                                    style={{ fontFamily: "'Space Grotesk', sans-serif", textShadow: '0 0 20px rgba(0,242,255,0.4)' }}
                                >
                                    RSMK
                                </span>
