...
const NotFound: React.FC = () => {
    return (
        <div className="min-h-screen relative selection:bg-lime-500/30 font-mono text-gray-300">
            <Helmet>
            ...
            <div className="relative z-10 min-h-screen flex flex-col items-center justify-center text-center p-6">
                ...
                <div className="mb-8 relative">
                    <div className="text-[120px] md:text-[200px] font-black leading-none select-none">
                        ...
                        <span className="text-lime-400 drop-shadow-[0_0_30px_rgba(57,255,20,0.5)]">0</span>
                        <span className="text-transparent bg-clip-text bg-gradient-to-b from-gray-800 to-gray-900">4</span>
                    </div>
                    {/* Scanline overlay */}
                ...
                <div className="mb-4">
                    <span className="text-xs font-mono text-lime-500 tracking-[0.3em] uppercase">ERROR_CODE: MODULE_NOT_FOUND</span>
                </div>
                ...
                <div className="flex gap-4 flex-wrap justify-center">
                    <Link
                        to="/"
                        className="px-8 py-3 bg-lime-500 text-black font-bold uppercase tracking-wider rounded-sm hover:bg-white hover:shadow-[0_0_30px_rgba(57,255,20,0.6)] transition-all"
                    >
                        Return Home
                    </Link>
                    <Link
                        to="/#projects"
                        className="px-8 py-3 border border-gray-700 text-gray-300 font-bold uppercase tracking-wider rounded-sm hover:border-lime-500 hover:text-lime-400 transition-all backdrop-blur-sm bg-black/50"
                    >
                        View Projects
                    </Link>
                </div>
                ...
                <div className="mt-16 text-left bg-black/60 border border-gray-800 rounded-lg p-4 max-w-md w-full font-mono text-xs">
                    ...
                    <div className="text-lime-400">&gt; Try navigating to <span className="text-white">/</span> or <span className="text-white">/#projects</span></div>
                    <div className="mt-2 flex items-center gap-1">
                        <span className="text-green-500">➜</span>
                        <span className="w-2 h-4 bg-lime-500 animate-pulse inline-block ml-1" />
                    </div>
                </div>
            </div>
        </div>
