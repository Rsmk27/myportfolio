            ...
            <main className="container mx-auto px-6 pt-32 pb-32">
                ...
                <section className="min-h-[85vh] flex flex-col items-center justify-center text-center mb-32 relative">
                    ...
                    <div className="relative z-20 max-w-4xl min-h-[400px] flex flex-col items-center justify-center">
                        ...
                        {/* Control Module - Moves from Center to Header */}
                        <motion.div
                            layout
                            className={`flex flex-col items-center gap-8 fixed transition-all duration-1000 ease-in-out z-[100] ${!isPowered
                                ? 'inset-0 items-center justify-center bg-black/90 backdrop-blur-sm'
                                : 'bottom-8 right-8 scale-[0.25] origin-bottom-right bg-transparent pointer-events-auto'
                                }`}
                        >
                            <motion.div
                                layout
                ...
                {/* Footer info */}
                <section className="text-center opacity-40 hover:opacity-100 transition-opacity pt-20 border-t border-[#111]">
                    <div className="inline-flex items-center gap-2 px-4 py-2 border border-gray-800 rounded-full">
